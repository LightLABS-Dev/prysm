...
import (
	...
	"github.com/lightlabs-dev/prysm/interchaintest/icsdirect/chainsuite"
)
...
func TestICS6ConsumerNoKeysChainLaunch(t *testing.T) {
	s := &ConsumerLaunchSuite{
		...
		OtherChainVersionPreUpgrade:  "v6.2.1", // OtherChainVersionPreUpgrade:  selectConsumerVersion("v6.0.0", "v6.2.1"),
...
func (s *ConsumerLaunchSuite) TestChainLaunch() {
	...
	fmt.Println("Consumer Launch Test Setup", cfg)
